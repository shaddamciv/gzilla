...
import * as sty from "./PlasmicButtonTwitter.module.css"; // plasmic-import: 3DOOUgAQZgA/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Zy6woqf51h2/icon

export const PlasmicButtonTwitter__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicButtonTwitter__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
function PlasmicButtonTwitter__RenderFunc(props) {
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__clZlg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__teNeX)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicButtonTwitter__ArgProps,
      internalVariantPropNames: PlasmicButtonTwitter__VariantProps
    });

    const { dataFetches } = props;
    return PlasmicButtonTwitter__RenderFunc({
      variants,
      args,
      overrides,
      dataFetches,
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonTwitter";
  } else {
    func.displayName = `PlasmicButtonTwitter.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonTwitter = Object.assign(
  // Top-level PlasmicButtonTwitter renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonTwitter
    internalVariantProps: PlasmicButtonTwitter__VariantProps,
    internalArgProps: PlasmicButtonTwitter__ArgProps,
    useBehavior
  }
);

export default PlasmicButtonTwitter;
/* prettier-ignore-end */
